...
import yaml
import tarfile
from functional.utils import get_name_and_version_from_chart_tar
from functional.utils import github_api
...
def the_release_is_published(secrets):
    ...
    for release in j:
        ...
        if release['tag_name'] == expected_tag:
            ...
            logger.info(f"Check '{expected_report_asset}' is in release assets")
