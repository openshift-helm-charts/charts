...
```
    helm install -n <your-rhdh-project> --generate-name https://github.com/rhdh-bot/openshift-helm-charts/raw/developer-hub-1.2-8-CI/charts/redhat/redhat/developer-hub/1.2-8-CI/developer-hub-1.2-8-CI.tgz
```
...
```
    oc apply -f https://github.com/rhdh-bot/openshift-helm-charts/raw/developer-hub-1.2-8-CI/installation/rhdh-next-ci-repo.yaml
```
...
```
    ...
    podman run --rm -i -e KUBECONFIG=/.kube/config \
      ...
      verify --write-to-file https://github.com/rhdh-bot/openshift-helm-charts/raw/developer-hub-1.2-8-CI/charts/redhat/redhat/developer-hub/1.2-8-CI/developer-hub-1.2-8-CI.tgz
