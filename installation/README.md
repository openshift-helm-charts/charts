...
```
    helm install -n <your-rhdh-project> --generate-name https://github.com/rhdh-bot/openshift-helm-charts/raw/developer-hub-1.2-33-CI/charts/redhat/redhat/developer-hub/1.2-33-CI/developer-hub-1.2-33-CI.tgz
```
